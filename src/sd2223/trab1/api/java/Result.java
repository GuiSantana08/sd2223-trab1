...
public interface Result<T> {
	 ...
	 */
	enum ErrorCode{ OK, CONFLICT, NOT_FOUND, BAD_REQUEST, FORBIDDEN, INTERNAL_ERROR, NOT_IMPLEMENTED, UNAUTHORIZED, METHOD_NOT_ALLOWED, NOT_ACCEPTABLE, SERVICE_UNAVAILABLE, TIMEOUT};
